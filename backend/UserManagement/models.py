...
class Match(models.Model):
    player1 = models.ForeignKey(UserPro, on_delete=models.CASCADE, related_name="player1")
    player2 = models.ForeignKey(UserPro, on_delete=models.CASCADE, related_name="player2")
